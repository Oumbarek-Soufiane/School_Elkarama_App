                                            ...
                                            <div class="row g-2">
                                                <div class="col-6">
                                                    ...
                                                    <select name="groupe_id[]" id="groupe_id"
                                                        ...
                                                        data-placeholder="Select group" style="width: 100%;" required>
                                            ...
                                            <div class="row g-2">
                                                <div class="col-12">
                                                    <label for="sujet" class="form-label"
                                                        style="text-align: center">Topic</label>
                                                    <input required name="sujet" id="sujet" type="text"
                                            ...
                                            <div class="row g-2">
                                                <div class="col-6">
                                                    <label for="dateFin" class="form-label"
                                                        style="text-align: center">Deadline Date</label>
                                                    <input required name="dateFin" id="dateFin"
                                                ...
                                                <div class="col-6">
                                                    <label for="description" class="form-label"
                                                        style="text-align: center">Description</label>
