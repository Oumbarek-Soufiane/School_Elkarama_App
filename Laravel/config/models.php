...
return [
    ...
    */
    ...
    '*' => [
        ...
        */
        ...
        'tuteur' => Illuminate\Database\Eloquent\Model::class,
    ...
    */
    ...
    |
    | You may wish to use connection specific config for setting a tuteur
    ...
    */
    ...
    //    'connections' => [
    //        'read_only_external' => [
    //            'tuteur' => \App\Models\ReadOnlyModel::class,
    //            'connection' => true,
    //            'users' => [
    //                'connection' => false,
    //            ],
