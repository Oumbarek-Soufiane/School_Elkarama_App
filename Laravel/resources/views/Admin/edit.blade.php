...
<head>
    ...
    <title>Edit {{ $roleDisplayed }}</title>
</head>
        ...
        <div class="content-wrapper bg-white">
            ...
            <div class="content-header mt-5">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit {{ $roleDisplayed }}</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">{{ $roleDisplayed }}</a></li>
                                <li class="breadcrumb-item active">Edit {{ $roleDisplayed }}</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="container">
                            <h1 class="mt-2">Edit {{ $roleDisplayed }}</h1>
                            <div class="row justify-content-center">
                                @if (file_exists(public_path('img' . $currentRole->user->photo)))
                                    <img class="img-fluid img-thumbnail custom-thumbnail "
                                        src='{{ @asset('img' . $currentRole->user->photo) }}' width="250"
                                        alt="Picture not found">
                                @else
                                    <div class="justify-content-center">
                                        <img src='{{ @asset('img/profil_pic_not_found.jpg') }}' width="150"
                                            class="img-fluid img-thumbnail custom-thumbnail " alt="Picture not found">
                                        <h6 class="text-danger">Error: Image not found</h6>
                                    </div>
                                @endif
                            </div>
                            <form method="post"
                                action="{{ url('admin/' . $roleOfCurrentPage . '/' . $currentRole->id) }}"
                                ...
                                <div class="row g-3">
                                    <div class="col-6 col-md-4">
                                        ...
                                        <input required name="prenom" id="prenom" type="text"
                                            value="{{ $currentRole->user->prenom }}" class="form-control" required>
                                    ...
                                    <div class="col-6 col-md-4">
                                        ...
                                        <input required name="nom" id="nom" type="text"
                                            value="{{ $currentRole->user->nom }}" class="form-control">
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-6 col-md-4 form-group">
                                        ...
                                        <select required name="genre" id="genre" class="form-control select3"
                                            ...
                                            <option @php if($currentRole->user->genre == 'M'){echo "selected";} @endphp
                                                value="M">Male</option>
                                            <option @php if($currentRole->user->genre == 'F'){echo "selected";} @endphp
                                    ...
                                    <div class="col-6 col-md-4">
                                        ...
                                        <input required name="email" id="email" type="email"
                                            value="{{ $currentRole->user->email }}" class="form-control">
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-6 col-md-4">
                                        ...
                                        <input required name="numeroTelephone" id="numeroTelephone" type="tel"
                                            value="{{ $currentRole->user->numeroTelephone }}" class="form-control">
                                            ...
                                            <select required name="filiere_id" id="filiere_id"
                                                ...
                                                @foreach ($filieres as $filiere)
                                                    <option
                                                        @php
if($roleOfCurrentPage == 'etudiant'){
                                                        if($currentRole->groupe->filiere_id == $filiere->id){echo "selected";}
                                                    }else{
                                                            if($currentRole->groupes_details[0]->groupe->filiere_id == $filiere->id){echo "selected";}
                                                    } @endphp
                                                        value={{ $filiere->id }}>
                                                        {{ $filiere->designation }}
                                                    </option>
                                        ...
                                        @if ($roleOfCurrentPage == 'etudiant')
                                            <div class="col-6 col-md-4">
                                                ...
                                                <input value="{{ $currentRole->couvertureMedicale }}"
                                                    name="couvertureMedicale" id="couvertureMedicale" type="text"
                                                    class="form-control">
                                            </div>
                                        @endif
                                    @endif
                                    ...
                                    <div class="col-6 col-md-4">
                                        ...
                                        <input required name="dateNaissance" id="dateNaissance" type="date"
                                            value={{ $currentRole->user->dateNaissance }} class="form-control">
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-6 col-md-4">
                                        ...
                                        <select required name="situationFamiliale" id="situationFamiliale"
                                            ...
                                            <option
                                                @php if($currentRole->user->situationFamiliale == 'celibataire'){echo "selected";} @endphp
                                                value="celibataire">Single</option>
                                            <option
                                                @php if($currentRole->user->situationFamiliale == 'marier'){echo "selected";} @endphp
                                                value="marier">Married</option>
                                            <option
                                                @php if($currentRole->user->situationFamiliale == 'divorcer'){echo "selected";} @endphp
                                                value="divorcer">Divorced</option>
                                        </select>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    ...
                                    @if ($roleOfCurrentPage == 'professeur')
                                        <div class="col-6 col-md-4">
                                            ...
                                            <input required name="diplome" id="diplome" type="text"
                                                value="{{ $currentRole->diplome }}" class="form-control" required>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-6 col-md-4">
                                            ...
                                            <input required name="dateEmbauche" id="dateEmbauche" type="date"
                                                value={{ $currentRole->dateEmbauche }} class="form-control" required>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-6 col-md-4">
                                            ...
                                            <input required name="salaire" id="salaire" type="number"
                                                step="0.01" value={{ $currentRole->salaire }} class="form-control"
                                                required>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                                ...
                                                <select name="etudiant_id[]" id="etudiant_id"
                                                    ...
                                                    @foreach ($etudiants as $etudiant)
                                                        <option value="{{ $etudiant->id }}"
                                                            @php if(in_array($etudiant->id,$tuteurDetail )){echo "selected";} @endphp>
