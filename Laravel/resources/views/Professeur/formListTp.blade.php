        ...
        <div class="content-wrapper bg-white">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="container">
                            <h1 class="mt-2">Show Homeworks
                            </h1>
                            <form method="post" class="form_customized needs-validation"
                            style="margin: 5% auto; max-width: 260px;"
                            action="{{ route('tp.storelist') }}" novalidate
                                enctype="multipart/form-data">
                                @csrf
                                <label for="groupe_id" style="text-align: center;" class="form-label"
                                    style="text-align: center">Group</label>
                                <select required name="groupe_id" id="groupe_id" class="form-control select3 mb-2"
