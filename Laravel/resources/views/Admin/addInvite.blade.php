        ...
        <div class="content-wrapper bg-white">
            ...
            <div class="content-header mt-5">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Invites</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Invites</a></li>
                                <li class="breadcrumb-item active">Edit Invites</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="container">
                            <h1 class="mt-2">Edit Invites</h1>
                            <div class="row justify-content-center">
                                @if (file_exists(public_path('img' . $user->invitePhoto)))
                                    <img class="img-fluid img-thumbnail custom-thumbnail "
                                        src='{{ @asset('img' . $user->invitePhoto) }}' width="250"
                            ...
                            <form method="post" action="{{ url('admin/invites/' . $invite_id . '/accept') }}"
                                ...
                                <div class="row g-3">
                                    <div class="col-6 col-md-4">
                                        ...
                                        <input required name="prenom" id="prenom" type="text"
                                            value="{{ $user->prenom }}" class="form-control" required>
                                    ...
                                    <div class="col-6 col-md-4 form-group">
                                        ...
                                        <select required name="genre" id="genre" class="form-control select3"
                                            ...
                                            <option @php if($user->genre == 'M'){echo "selected";} @endphp
                                                value="M">Male</option>
                                            <option @php if($user->genre == 'F'){echo "selected";} @endphp
                                    ...
                                    <div class="col-6 col-md-4">
                                        ...
                                        <input required name="numeroTelephone" id="numeroTelephone" type="tel"
                                            value="{{ $user->numeroTelephone }}" class="form-control">
                                    ...
                                    <div class="col-6 col-md-4">
                                        ...
                                        <select required name="filiere_id" id="filiere_id"
                                            ...
                                            @foreach ($filieres as $filiere)
                                                <option
                                                    @php
if($user->filiere_id == $filiere->id){echo "selected";} @endphp
                                                    value={{ $filiere->id }}>
                                                    {{ $filiere->designation }}
                                                </option>
                                            @endforeach
                                    ...
                                    <div class="col-6 col-md-4">
                                        ...
                                        <input value="{{ $user->couvertureMedicale }}"
                                    ...
                                    <div class="col-6 col-md-4">
                                        ...
                                        <input required name="dateNaissance" id="dateNaissance" type="date"
                                            value={{ $user->dateNaissance }} class="form-control">
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-6 col-md-4">
                                        ...
                                        <select required name="situationFamiliale" id="situationFamiliale"
                                            ...
                                            <option
                                                @php if($user->situationFamiliale == 'celibataire'){echo "selected";} @endphp
                                                value="celibataire">Single</option>
                                            <option
                                                @php if($user->situationFamiliale == 'marier'){echo "selected";} @endphp
                                                value="marier">Married</option>
                                            <option
                                                @php if($user->situationFamiliale == 'divorcer'){echo "selected";} @endphp
                                    ...
                                    <div class="col-6 col-md-4 ">
                                        ...
                                        <input name="photo" id="photo" class="form-control" type="file"
                                            accept="image/*">
                                        {{-- <input name="invitePhoto" id="invitePhoto" class="form-control" type="text" value="{{'img' . $user->invitePhoto}}" hidden> --}}
                                        <input name="invitePhoto" id="invitePhoto" class="form-control" type="text" value="{{ public_path('img' . $user->invitePhoto)}}" hidden>
                                ...
                                <div class="row d-flex justify-content-end mt-2">
                                    ...
                                    <input type="text" name="role" id="role" value="etudiant" hidden>
